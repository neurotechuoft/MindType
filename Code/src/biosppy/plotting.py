...
def plot_bvp(ts=None,
             ...
             path=None,
             show=False):
    """Create a summary plot from the output of biosignals.bvp.bvp.
...
def plot_eda(ts=None,
             ...
             path=None,
             show=False):
    """Create a summary plot from the output of biosignals.eda.eda.
...
def plot_emg(ts=None,
             ...
             path=None,
             show=False):
    """Create a summary plot from the output of biosignals.emg.emg.
...
def plot_eeg(ts=None,
             ...
             path=None,
             show=False):
    """Create a summary plot from the output of biosignals.eeg.eeg.
...
def plot_ecg(ts=None,
             ...
             path=None,
             show=False):
    """Create a summary plot from the output of biosignals.ecg.ecg.
