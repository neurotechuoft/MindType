...
def phase_locking(signal1=None, signal2=None, N=None):
    """Compute the Phase-Locking Factor (PLF) between two biosignals.
    ...
    -------
    plf : float
        The PLF between the two biosignals.
    ...
    if len(signal1) != len(signal2):
        raise ValueError("The input biosignals must have the same length.")
...
def synchronize(signal1=None, signal2=None):
    """Align two biosignals based on cross-correlation.
