...
# put in "lib" folder (same level as main.py)
...
class StreamerLSL(plugintypes.IPluginExtended):
	...
	def activate(self):
		...
		print("Creating LSL stream for EEG. Name:", eeg_stream, "- ID:", eeg_id,
			  "- data type: float32.", self.eeg_channels, "channels at",
			  self.sample_rate, "Hz.")
		...
		print("Creating LSL stream for AUX. Name:", aux_stream, "- ID:", aux_id,
			  "- data type: float32.", self.aux_channels, "channels at",
			  self.sample_rate, "Hz.")
		...
		if self.imp_channels > 0:
			print("Creating LSL stream for Impedance. Name:", imp_stream,
				  "- ID:", imp_id, "- data type: float32.", self.imp_channels,
				  "channels at", self.sample_rate, "Hz.")
