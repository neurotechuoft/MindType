    ...
    return (
      <div className="userInput">
        <div>
          ...
          <button className="entry row1 col6">$</button>
        </div>
        <div>
          ...
          <button className="entry row2 col6">~</button>
          </div>
        <div>
          ...
          <button className="entry row3 col6">*</button>
        </div>
        <div>
          ...
          <button className="entry row4 col6">"</button>
        </div>
        <div>
          <button className="entry row5 col1">9</button>
          <button className="entry row5 col2">0</button>
          <button className="entry row5 col3">(</button>
          <button className="entry row5 col4">)</button>
          <button className="entry row5 col4">/</button>
