...
class LettersSmall extends Component {
  ...
  render() {
    return (
      <div className="userInput">
            ...
            <br />
            <button className="entry entry-extra-wide-small leftMost row5 col1">____</button>
            <button className="entry entrySmall row5 col3">y</button>
            <button className="entry entrySmall row5 col4">z</button>
            <button className="entry entry-extra-wide-small row5 col5">&uarr;</button>
      </div>
    )
  }
}

export default LettersSmall;